...
//     headline.setAttribute('class', 'modall-headline');
//     var headline_text = document.createTextNode('Modal UI Component');
//     headline.applendChild(headline_text);
//     return headline;
//   }
//
//   // 버튼 요소 객체에 이벤트 연결
...
var main_parentNode = main.parentNode;
var main = document.querySelector('#main');
var divider = createEl('hr');

main_parentNode.insertBefore(divider, main);

var issue = document.querySelectorAll('.issue');
var issue_parentNode = issue.parentNode;
var divider_issue = document.createElement('hr');

issue_parentNode.insertBefore(divider_issue, issue);
